...
describe('#updateStage()', () => {
  ...
  it('passes credential provider functions to API Gateway and CloudWatch Logs clients', async () => {
    ...
    const getAwsSdkV3ConfigStub = sinon.stub(awsProvider, 'getAwsSdkV3Config').resolves({
      credentials,
      region: 'us-east-1',
    });
    context.state.service.provider.logs = {
