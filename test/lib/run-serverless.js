...
module.exports = async (
  ...
  if (modulesCacheStub) {
    const httpsProxyAgentPath = require.resolve('https-proxy-agent');
    if (!modulesCacheStub[httpsProxyAgentPath]) {
      modulesCacheStub[httpsProxyAgentPath] = require('https-proxy-agent');
    }
  }
