...
const promiseLimit = require('../utils/promise-limit');
...
if (proxy) {
  sdk.config.httpOptions.agent = new HttpsProxyAgent(proxy, agentOptions);
  ...
  sdk.config.httpOptions.agent = new https.Agent(agentOptions);
}
