...
/**
 * Get S3-specific client configuration
 * @param {Object} baseConfig - Base client configuration
 * @param {boolean} useAcceleration - Whether to use S3 transfer acceleration
 * @returns {Object} S3 client configuration
 */
function buildS3Config(baseConfig = {}, useAcceleration = false) {
  const s3Config = { ...baseConfig };
...
function shouldUseS3Acceleration(method, params) {
  ...
  return (
    accelerationCompatibleMethods.has(method) &&
    params &&
