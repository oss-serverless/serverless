...
class AwsProvider {
  ...
  /**
   * Execute an AWS request - routes between v2 and v3 based on feature flag
  ...
  async request(service, method, params, options) {
    ...
    return this.requestV2(service, method, params, options);
  }

  /**
   * Execute an AWS request by calling the AWS SDK v2
   * @param {string} service - Service name
   * @param {string} method - Method name
   * @param {Object} params - Parameters
   ...
   */
  async requestV2(service, method, params, options) {
