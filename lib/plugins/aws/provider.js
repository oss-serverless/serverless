...
class AwsProvider {
  ...
  async getServerlessDeploymentBucketName() {
    ...
    return this._awsRequest('CloudFormation', 'describeStackResource', {
  ...
  getStackResources(next, resourcesParam) {
    ...
    return this._awsRequest('CloudFormation', 'listStackResources', params).then((res) => {
...
Object.defineProperties(
  ...
  memoizeeMethods({
    getAccountInfo: d(
      async function () {
        const result = await this._awsRequest('STS', 'getCallerIdentity', {});
    ...
    getOrCreateEcrRepository: d(
      async function (scanOnPush) {
        ...
        let repositoryUri;
        try {
          const result = await this._awsRequest('ECR', 'describeRepositories', {
          ...
          const result = await this._awsRequest('ECR', 'createRepository', {
            repositoryName,
    ...
    resolveImageUriAndShaFromUri: d(
      async function (image) {
        ...
        const describeImagesResponse = await this._awsRequest('ECR', 'describeImages', {
          imageIds: [
            {
              imageTag,
            },
