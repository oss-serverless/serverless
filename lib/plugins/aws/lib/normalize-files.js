...
module.exports = {
  normalizeCloudFormationTemplate(template) {
    ...
    Object.entries(normalizedTemplate.Resources).forEach(([key, value]) => {
      ...
      if (key === 'WebsocketsDeploymentStage' && value.Properties && value.Properties.DeploymentId) {
        const newVal = value;
        newVal.Properties.DeploymentId.Ref = 'WebsocketsDeployment';
      }
      if (value.Type && value.Type === 'AWS::Lambda::Function' && value.Properties && value.Properties.Code) {
        const newVal = value;
      ...
      if (
        ...
        value.Properties && value.Properties.Content
      ) {
        const newVal = value;
