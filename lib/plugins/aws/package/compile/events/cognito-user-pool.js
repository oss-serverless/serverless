...
class AwsCompileCognitoUserPoolEvents {
          ...
          if (event.cognitoUserPool) {
            ...
            cognitoUserPoolTriggerFunctions.forEach((cognitoUserPoolTriggerFunction) => {
              ...
              const permissionTemplate = {
                ...
                DependsOn: triggerFunctionObj.targetAlias && triggerFunctionObj.targetAlias.logicalId,
                Properties: {
  ...
  mergeWithCustomResources() {
    ...
    userPools.forEach((poolName) => {
      ...
      if (this.serverless.service.resources && this.serverless.service.resources[userPoolLogicalId]) {
        ...
        this.serverless.service.provider.compiledCloudFormationTemplate.Resources[userPoolLogicalId] =
          mergedTemplate;
      }
    });
  }
