...
module.exports = {
  compileCors() {
    if (this.validated.corsPreflight) {
      Object.entries(this.validated.corsPreflight).forEach(([path, config]) => {
        ...
        this.serverless.service.provider.compiledCloudFormationTemplate.Resources[corsMethodLogicalId] = {
          ...
          Properties: {
            ...
            Integration: {
              ...
              IntegrationResponses: this.generateCorsIntegrationResponses(preflightHeaders, origins),
            },
  ...
  generateCorsIntegrationResponses(preflightHeaders, origins) {
    const responseParameters = Object.fromEntries(
      Object.entries(preflightHeaders).map(([header, value]) => [
