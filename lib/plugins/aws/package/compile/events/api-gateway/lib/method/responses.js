    ...
    if (http.integration === 'AWS' || http.integration === 'HTTP' || http.integration === 'MOCK') {
      if (http.response) {
        ...
        if (http.cors) {
          ...
          Object.assign(methodResponseHeaders, {
        ...
        if (http.response.headers) {
          Object.assign(methodResponseHeaders, http.response.headers);
        }
        ...
        Object.entries(http.response.statusCodes).forEach(([statusCode, config]) => {
          ...
          Object.assign(methodResponse.ResponseParameters, this.getMethodResponseHeaders(methodResponseHeaders));

          if (config.headers) {
            Object.assign(methodResponse.ResponseParameters, this.getMethodResponseHeaders(config.headers));
          }
