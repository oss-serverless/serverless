...
module.exports = {
  ...
  async updateStage() {
    ...
    await resolveRestApiId.call(this);
    if (this.apiGatewayRestApiId) await resolveDeploymentId.call(this);
    ...
    await resolveStage.call(this);
    await ensureStage.call(this);
    handleTracing.call(this);
    handleMetrics.call(this);
    handleLogs.call(this);
    handleTags.call(this);
    await applyUpdates.call(this);
    await addTags.call(this);
    await removeTags.call(this);
    return removeAccessLoggingLogGroup.call(this);
  },
};
...
function isApiGatewayGetStageNotFoundError(error) {
  ...
  const statusCode = (providerError && providerError.statusCode) || (error && error.statusCode);

  return code === 'NotFoundException' || statusCode === 404;
}
...
async function resolveStage() {
  ...
  return this.provider
    ...
    .catch((error) => {
      if (isApiGatewayGetStageNotFoundError(error)) return;
      throw error;
    });
}
