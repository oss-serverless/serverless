...
module.exports = {
  ...
  async updateStage() {
    ...
    let awsSdkV3ConfigPromise;
    const getAwsSdkV3Config = () => {
      if (!awsSdkV3ConfigPromise) awsSdkV3ConfigPromise = this.provider.getAwsSdkV3Config();
      return awsSdkV3ConfigPromise;
    };
    const getApiGateway = createAwsSdkV3ClientGetter(getAwsSdkV3Config, APIGatewayClient);
    const getCloudWatchLogs = createAwsSdkV3ClientGetter(getAwsSdkV3Config, CloudWatchLogsClient);
