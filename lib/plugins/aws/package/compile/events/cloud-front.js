...
class AwsCompileCloudFrontEvents {
  ...
  compileCloudFrontEvents() {
    ...
    function extendDeep(object, source) {
      for (const [key, sourceValue] of Object.entries(source)) {
        ...
        if (Array.isArray(targetValue) && Array.isArray(sourceValue)) {
          object[key] = uniqWith(targetValue.concat(sourceValue), isDeepStrictEqual);
          continue;
        }
        ...
        if (targetValue === undefined) {
          object[key] = structuredClone(sourceValue);
        }
      }
    ...
    if (lambdaAtEdgeFunctions.length) {
      ...
      if (
        behaviors.some((o) => {
          return o.LambdaFunctionAssociations.length !== uniqBy(o.LambdaFunctionAssociations, 'EventType').length;
        })
      ) {
        throw new ServerlessError(
