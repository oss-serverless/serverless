...
class AwsCompileFunctions {
  ...
  async compileFunction(functionName) {
    ...
    if (functionObject.logs) {
      const loggingConfig = {};

      if (functionObject.logs.applicationLogLevel) {
        loggingConfig.ApplicationLogLevel = functionObject.logs.applicationLogLevel;
      }

      if (functionObject.logs.logFormat) {
        loggingConfig.LogFormat = functionObject.logs.logFormat;
      }

      if (functionObject.logs.logGroup) {
        loggingConfig.LogGroup = functionObject.logs.logGroup;
      }

      if (functionObject.logs.systemLogLevel) {
        loggingConfig.SystemLogLevel = functionObject.logs.systemLogLevel;
      }
