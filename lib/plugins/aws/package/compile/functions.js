...
const { createRegistry, hasOwn, safeShallowAssign } = require('../../../../utils/safe-object');
  ...
  compileRole(newFunction, role) {
    ...
    if (typeof role === 'string') {
      if (role.startsWith('arn:')) {
        ...
        // role is the default role generated by OSLS Framework
