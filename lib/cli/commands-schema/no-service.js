...
commands.set('dashboard', {
  usage: 'Open the Serverless Framework Dashboard',
...
commands.set('login', {
  usage: 'Login or register for Serverless Framework',
  serviceDependencyMode: 'optional',
  lifecycleEvents: ['login'],
  options: {
    dashboard: {
      usage: 'Log into Serverless Framework',
      type: 'boolean',
    },
  },
});
...
commands.set('output get', {
  usage: 'Get the value of an output from this Service and Stage. Must be logged in.',
  serviceDependencyMode: 'optional',
  hasAwsExtension: true,
  options: {
    name: { usage: 'Output name', required: true },
...
commands.set('output list', {
  usage: 'List the values of outputs from this Service and Stage. Must be logged in.',
  serviceDependencyMode: 'optional',
  hasAwsExtension: true,
  options: {
    service: { usage: 'Dashboard service' },
...
commands.set('param get', {
  usage: 'Get value of a parameter set for this Service and Stage. Must be logged in.',
  serviceDependencyMode: 'optional',
  hasAwsExtension: true,
  options: {
...
commands.set('param list', {
  usage: 'List all values of parameters set for this Service and Stage. Must be logged in.',
  serviceDependencyMode: 'optional',
  hasAwsExtension: true,
  lifecycleEvents: ['list'],
});
