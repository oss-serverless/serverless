...
// osls compose only needs the interactivity check and not the full logger setup.
...
module.exports = async () => {
  ...
  if (isInteractive) {
    ...
    const failedInstallationErrorMessage = `${[
      '',
      'Installation failed. Make sure the "@osls/compose" package is required in "package.json" in the current directory so that osls installs osls compose automatically.',
