...
//
// Known limitation: when a whole section resolves from a single variable
// (e.g. `params: ${file(./params.yml)}` or `params.prod: ${file(./prod-params.yml)}`), it is
// resolved eagerly as before. Such a section cannot be left unresolved: the configuration schema
// requires `params.<stage>` to be an object, and a raw variable string would fail validation.
