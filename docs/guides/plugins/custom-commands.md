...
OSLS Framework plugins can define custom CLI commands.
...
If a plugin defines a command name that conflicts with OSLS Framework core or another plugin, the CLI will exit with an error.
